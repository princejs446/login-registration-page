...
import 'package:userauthentication/register.dart';
...
child: Column(
  ...
  children: [
    ...
    SizedBox(height: 60),
    SizedBox(height: 50,width: double.infinity,child: ElevatedButton(onPressed: _login,
    style: ElevatedButton.styleFrom(
     ...
     Center(
      child: TextButton(
       ...
       child: Text("Go to Registeration",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),
      ),
      ),
     ),
      ],
